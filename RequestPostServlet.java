...
public class RequestPostServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//요청처리가 다되었다는 가정하에 사용자가 보게될 응답 html 작성
		...
		RequestDispatcher view = request.getRequestDispatcher("/views/responsePage.jsp"); // url과는 다름!!, 파일경로 찾을때는 절대경로 루트는 webapp이다
		view.forward(request, response);												  // 상대경로에서 상위폴더로 나갈려면 ../views~ 하면된다
